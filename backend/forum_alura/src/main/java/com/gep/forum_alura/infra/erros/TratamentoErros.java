...
public class TratamentoErros {
    ...
    public ResponseEntity<List<?>> error400Handler(MethodArgumentNotValidException e){
        var error = e.getFieldErrors().stream().map(validacaoErrosDados::new).toList();
    ...
    @ExceptionHandler(IntegrityValidacao.class)
    ...
    private record validacaoErrosDados(String field, String erro){
